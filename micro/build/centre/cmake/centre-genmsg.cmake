...
set(MSG_I_FLAGS "-Icentre:/Music/qr_voice/micro/src/centre/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/Music/qr_voice/micro/src/centre/msg/event.msg" NAME_WE)
add_custom_target(_centre_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "centre" "/Music/qr_voice/micro/src/centre/msg/event.msg" ""
)
...
_generate_msg_cpp(centre
  "/Music/qr_voice/micro/src/centre/msg/event.msg"
  "${MSG_I_FLAGS}"
  ""
